...
- [ ] **4.1** Design the main overlay window (ImGui) showing: current shanten, best discard, ukeire count, reasoning text.
- [ ] **4.2** Display the full ranked suggestion list (all discard options sorted by confidence).
...
- [ ] **4.5** Add toggle to show/hide the overlay, and a compact mode (just the best discard tile name).
